...
"""
convertir une valeur rgb en hexadécimal
"""
def rgb2hex(r, g, b):
    return f'#{r:02x}{g:02x}{b:02x}'

"""
affiche un réseau dans un canvas tkinter

fonction un peu dégueu mais ça fonctionne
"""
def show_network(network, canvas,width,height):
      
    canvas.delete("all")    #vider le canvas
    ...
    #afficher les poids entre les neurones
...
"""
Ouvre une visualisation d'un réseau dans une fentre tkinter

si aucun réseau n'est passé en parametre, celui par défaut est chargé ("big_bauss.pkl")
"""    
def lauch_visualisation(network):
    ...
    #afficher le réseau de nouveau quand la fenetre est redimensionnée
...
sépare les données d'entrainement en plus petits échantillons (batch)
"""
...
change le taux d'entrainement pour chaque itération
"""   
...
similaire a adadelta mais implémente la séparation des échantillons
"""        
...
se sert de la moyenne et variation des gradient 
...
toute la splendeur de adam mais avec la séparation des échantillons
"""    
